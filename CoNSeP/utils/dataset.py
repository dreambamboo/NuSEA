...
def get_trainingset():
    # path for training sey
    trainingset_path = "CoNSeP_Train_Data.dat" #You may get this file at https://mcprl.com/html/dataset/NuSEA.html
    trainingset_file = open(trainingset_path,"rb")
    training_dict = pickle.load(trainingset_file) 
    trainingset_file.close()
    print(training_dict["info"],training_dict["average_size"])
