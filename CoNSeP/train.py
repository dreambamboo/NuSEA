...
class Option(object):
    def __init__(self):
        ...
        self.pretrain_net = os.path.join(self.model_dir,'CoNSeP.pth')#You may get this file at https://mcprl.com/html/dataset/NuSEA.html
        ...
        self.env = 'cell-CoNSeP'
        self.net_select = 'unet-dcn'#'unet-light3'#'unet-dcn'#'unet-transpose'
        self.early_stop = 50
        self.epochs = 100 
        self.check_epoch = 5
        ...
        # test
        self.testset_crop_images = 'CoNSePTestData.dat' #You may get this file at https://mcprl.com/html/dataset/NuSEA.html
        self.testset_truth = 'CoNSePTestData-truth.dat' #You may get this file at https://mcprl.com/html/dataset/NuSEA.html
        self.test_threshold = 0.5 # threshold
        self.is_eval_instance = False # if object-level evaluation is wanted: True
        self.is_assist_test = False # default: False
        self.is_save = False # save results or not
    ...
    def _test_(self):
        ...
        for class_dir in ['none']:
            for img_name in tqdm(testset_dict['none'].keys()):
                ...
                truth = testset_truth[class_dir][img_name][0] 
                truth_h,truth_w = truth.shape
